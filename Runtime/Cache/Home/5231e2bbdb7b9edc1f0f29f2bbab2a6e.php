...
<!--头部-->
    <div class="header">
        ...
        <div id="menu" class="menu">
            <ul class="mwrap">
                <li class="mli"> <a href="<?php echo U('Index/index');?>" class="mlink curr" id="topMenu1"> <span class="mico mico_home"><span class="micoi"></span></span> <span class="mname">首页</span> </a> </li>
