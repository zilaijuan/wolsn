...
<head>
    ...
    <link href="/wolsn/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/wolsn/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/wolsn/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/wolsn/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/wolsn/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/wolsn/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/wolsn/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script>
	...
	<script type="text/javascript" src="/wolsn/Public/static/uploadify/jquery.uploadify.min.js"></script>

	<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script> -->
	<!-- The jQuery UI widget factory, can be omitted if jQuery UI is already included -->
	<script src="/wolsn/Public/static/wolsn/jQuery_File_Upload/js/vendor/jquery.ui.widget.js"></script>
	<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
	<script src="/wolsn/Public/static/wolsn/jQuery_File_Upload/js/jquery.iframe-transport.js"></script>
	<!-- The basic File Upload plugin -->
	<script src="/wolsn/Public/static/wolsn/jQuery_File_Upload/js/jquery.fileupload.js"></script>
	<!-- Bootstrap JS is not required, but included for the responsive demo navigation -->
	<script src="/wolsn/Public/static/bootstrap/js/bootstrap.min.js"></script>
...
<div class="tab-wrap">
                    ...
                    <div class="controls">
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-medium" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
									<input type="file" id="upload_picture_<?php echo ($field["name"]); ?>" name="download">
									<input type="hidden" name="<?php echo ($field["name"]); ?>" id="cover_id_<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"/>
									<div class="upload-img-box">
									<?php if(!empty($data[$field['name']])): ?><div class="upload-pre-item"><img src="/wolsn<?php echo (get_cover($data[$field['name']],'path')); ?>"/></div><?php endif; ?>
									</div>
								</div>
								<div>
								...
								<script type="text/javascript">
									$('#upload_picture_<?php echo ($field["name"]); ?>').fileupload({
									    url: "<?php echo U('File/uploadPicture',array('session_id'=>session_id()));?>",
									    dataType: 'json',
									    acceptFileTypes: /(\.|\/)(gif|jpe?g|png)$/i,
									    done: function (e, data) {
									    	uploadPicture<?php echo ($field["name"]); ?>("file", data.result)
									    },
							 ...
							 //        "height"          : 30,
							 //        "swf"             : "/wolsn/Public/static/uploadify/uploadify.swf",
    ...
    <script type="text/javascript" src="/wolsn/Public/static/think.js"></script>
    <script type="text/javascript" src="/wolsn/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/wolsn/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/wolsn/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/wolsn/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/wolsn/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/wolsn/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
